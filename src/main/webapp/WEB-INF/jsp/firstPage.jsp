...
<div class="section1 w">
    ...
    <div class="right hidden-sm hidden-xs">
        <div class="content">
            ...
            <div class="num">
                <img src="images/user.jpg" alt=""> <span>${counted}</span>
                <p>累计结业人数</p>
            </div>
        </div>
    </div>
    ...
    <div class="row xueyuan">
        <c:forEach items="${list}" var="Excellent">
            <div class="people col-xs-12 col-sm-12 col-md-3">
                <div class="touxiang">
                    <img src="${Excellent.picture}" alt="">
                </div>

                <p class="intro">${Excellent.profession} ${Excellent.name}</p>
...
<div class="section4 w container">
    <p><a href="task-92.html">战略合作企业</a></p>
    <ul class="com row">
